ATTACH TABLE _ UUID 'b6bd328c-b26d-4ff4-9622-152ab68ed30e'
(
    ...
    `ProfileEvent_SkippingIndexCacheHits` UInt64 COMMENT 'Number of times an index granule has been found in the skipping index cache.',
    `ProfileEvent_SkippingIndexCacheMisses` UInt64 COMMENT 'Number of times an index granule has not been found in the skipping index cache and had to be read from disk.',
    `ProfileEvent_SkippingIndexCacheWeightLost` UInt64 COMMENT 'Approximate number of bytes evicted from the secondary index cache.',
    ...
    `CurrentMetric_ActiveDataMutations` Int64 COMMENT 'Number of data mutations in all tables that are not finished and can be applied on the fly.',
    `CurrentMetric_ActiveMetadataMutations` Int64 COMMENT 'Number of metadata mutations in all tables that are not finished and can be applied on the fly.',
    ...
    `CurrentMetric_SkippingIndexCacheSize` Int64 COMMENT 'Size of the skipping index cache in bytes',
